...
const shoping_cart_model_1 = require("./shoping-cart.model");
...
exports.ShoppingCartModule = ShoppingCartModule = __decorate([
    (0, common_1.Module)({
        imports: [sequelize_1.SequelizeModule.forFeature([shoping_cart_model_1.ShoppingCart]), users_module_1.UsersModule, boiler_parts_module_1.BoilerPartsModule,],
